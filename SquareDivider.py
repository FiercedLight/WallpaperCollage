...
print("For best results pick square size, width, and height divisible by precision")
...
print(numpy.matrix(square_array))

width_limit_max = int(int(input('Rectangle width max limit (200): ') or "200")/square_precision)
width_limit_min = int(int(input('Rectangle width min limit (precision): ') or square_precision)/square_precision)
height_limit_max = int(int(input('Rectangle height max limit (300): ') or "300")/square_precision)
height_limit_min = int(int(input('Rectangle height min limit (precision): ') or square_precision)/square_precision)
